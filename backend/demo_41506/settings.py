"""
Django settings for demo_41506 project.
...
WSGI_APPLICATION = 'demo_41506.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_41506 API",
    "DESCRIPTION": "API documentation for demo_41506 App",
    "VERSION": "v1",
}
